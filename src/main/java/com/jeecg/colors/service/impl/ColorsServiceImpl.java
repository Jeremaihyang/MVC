package com.jeecg.colors.service.impl;
...
@Transactional
public class ColorsServiceImpl extends CommonServiceImpl implements ColorsServiceI {
	 ...
	 */
	 public void doResetBus(ColorsEntity t) throws Exception{
	 	//-----------------sql增强 start----------------------------
	 	//sql增强第1条
	 	String sqlEnhance_1 ="update colors set red='',green='',blue=''";
 	...
 	private Map<String,Object> populationMap(ColorsEntity t){
		...
		map.put("red", t.getRed());
		map.put("green", t.getGreen());
		map.put("blue", t.getBlue());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ColorsEntity t){
 		...
 		sql  = sql.replace("#{red}",String.valueOf(t.getRed()));
 		sql  = sql.replace("#{green}",String.valueOf(t.getGreen()));
 		sql  = sql.replace("#{blue}",String.valueOf(t.getBlue()));
	 ...
	 */
 	...
 	private void executeSqlEnhance(String sqlEnhance,ColorsEntity t){
