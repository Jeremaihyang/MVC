...
<head>
 ...
 <body class="gray-bg">
        <%--<div class="wrapper wrapper-content">--%>
           <%----%>
			<%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #cfa972;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div><!-- class="ibtn" -->&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon-zhihuizhongxin" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能1</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #f29b76;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon-yujing" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能2</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #acd598;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon-ln-" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能3</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #84ccc9;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon-wuliu" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能4</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #89c997;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon-quanshengmingzhouqiguanli" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能5</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #88abda;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon-jixiao" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能6</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
				<%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #8c97cb;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon-fangdajing-copy" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能7</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
				<%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #c490bf;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon--youhuajieduan" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能8</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
				<%--&lt;%&ndash;<div class="col-md-1 col-cs-2 col-xs-4">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<div class="widget  p-lg text-center" style="background: #f19ec2;">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<i class="iconfont icon-duoren" style="font-size: 30px;"></i>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<h3 class="font-bold no-margins"></h3>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<small>功能9</small>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;&ndash;%&gt;--%>
    ...
    <%--<div class="col-sm-12">--%>
        <%--&lt;%&ndash;<blockquote class="text-warning" style="font-size:14px">您是否需要一款企业级J2EE快速开发平台，提高开发效率，缩短项目周期…&ndash;%&gt;--%>
            <%--&lt;%&ndash;<br>您是否一直在苦苦寻找一款强大的代码生成器，节省码农的繁琐重复工作…&ndash;%&gt;--%>
            <%--&lt;%&ndash;<br>您是否想拥有移动报表能力、自定义表单设计能力、插件开发能力(可插拔)、工作流配置能力…&ndash;%&gt;--%>
            <%--&lt;%&ndash;<br>…………&ndash;%&gt;--%>
            <%--&lt;%&ndash;<h4 class="text-danger">那么，现在Jeecg来了</h4>&ndash;%&gt;--%>
        <%--&lt;%&ndash;</blockquote>&ndash;%&gt;--%>
        <%--<hr>--%>
    <%--</div>--%>
    <%--<div class="col-sm-3">--%>
        <%--&lt;%&ndash;<h2>Hello,Guest</h2>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<small>移动设备访问请扫描以下二维码：</small>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<br>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<br>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<img src="plug-in/login/images/jeecg.jpg" width="100%" style="max-width:264px;">&ndash;%&gt;--%>
        <%--&lt;%&ndash;<br>&ndash;%&gt;--%>
    <%--</div>--%>
    <%--<div class="col-sm-5">--%>
        <%--<h2>--%>
