...
<body>
                ...
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div>
                        <div style="float: right; margin-left:-30px; margin-right: 40px;">
                           	 技术支持： <font color="red">芸皓科技</font>   &nbsp;&nbsp;&nbsp;  官网: <font color="red"><a href="http://www.zgykkj.com"  target="_blank" >www.zgykkj.com</a></font>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; <t:mutiLang langKey="V_1.0"/> <span class="tip"><a href="http://www.zgykkj.com"  target="_blank" title=<t:mutiLang langKey="common.platform"/>芸皓科技</a> <t:mutiLang langKey="common.browser.recommend"/><a href="http://www.zgykkj.com" target="_blank" title=<t:mutiLang langKey="common.platform"/>> 芸皓</a></span></div>
    </div>
    <!-- Link JScript-->
